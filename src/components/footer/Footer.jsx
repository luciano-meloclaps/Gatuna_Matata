...
const Footer = () => {
  return (
    <div className="bg-primary-user">
      <div className="container col-12 d-flex justify-space-evenly">
        <footer className="row pt-5 border-top fixed-bot">
          <div className="col-4">
            <h1 className="font-marca pb-2 text-white">Gatuna Matata</h1>
            <ul className="p-0">
              <svg
